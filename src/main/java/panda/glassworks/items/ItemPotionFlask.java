...
public class ItemPotionFlask extends Item implements IMeta {
	public ItemPotionFlask() {
		...
		this.setHasSubtypes(true); // This allows the item to be marked as a
									// metadata item.
		this.setMaxDamage(0);
	...
	public String getItemStackDisplayName(ItemStack stack) {
		...
		return I18n.format("text.glassworks.potion_flask.name") + " "
				+ I18n.format(PotionUtils.getPotionFromItem(stack).getNamePrefixed("potion.effect."));
	}
