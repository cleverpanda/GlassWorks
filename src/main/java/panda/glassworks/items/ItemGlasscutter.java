...
public class ItemGlasscutter extends Item {
	private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(new Block[] { Blocks.GLASS, Blocks.GLASS_PANE,
			Blocks.GLOWSTONE, Blocks.STAINED_GLASS_PANE, Blocks.STAINED_GLASS });
