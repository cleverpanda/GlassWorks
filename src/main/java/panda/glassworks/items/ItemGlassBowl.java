...
public class ItemGlassBowl extends ItemArmor {
	static ArmorMaterial GLASS = EnumHelper.addArmorMaterial("glass",
			"glassworks:textures/models/armor/glass_bowl_layer_1.png", 10, new int[] { 0, 0, 0, 0 }, 0,
			SoundEvents.BLOCK_GLASS_PLACE, 0);
