...
public class ItemModelPerspective implements IPerspectiveAwareModel{
	...
	//public static final ModelResourceLocation MODEL2D = new ModelResourceLocation(GlassWorks.MODID + ":" + "blowpipe2d", "inventory");
	//public static final ModelResourceLocation MODEL3D = new ModelResourceLocation(GlassWorks.MODID + ":" + "blowpipe3d", "inventory");
