...
public class GuiBlowpipe extends GuiContainer {
	private static final ResourceLocation BLOWPIPE_GUI_TEXTURES = new ResourceLocation(
			"glassworks:textures/gui/blowpipe.png");
	...
	static class Button extends GuiButton {
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY) {
			...
			if (this.visible) {
				...
				{
					j += this.height * 2;
					// System.out.println((mouseX >= this.xPosition
					// )+","+(mouseY >= this.yPosition)+","+(mouseX <
					// this.xPosition + this.width)+","+(mouseY < this.yPosition
					// + this.height));
				} else if (flag)// mouse hover
				{
					j += this.height;
