...
public class BlockLantern extends Block {
	...
	protected static final AxisAlignedBB STANDING_AABB = new AxisAlignedBB(0.3125D, 0.0D, 0.3125D, 0.6875D, 0.8125D,
			0.6875D);
	protected static final AxisAlignedBB HANGING_AABB = new AxisAlignedBB(0.3125D, 0.0625D, 0.3125D, 0.6875D, 1.0D,
			0.6875D);

	protected static final AxisAlignedBB LANTERN_NORTH_AABB = new AxisAlignedBB(0.3125D, 0.0D, 0.6875D, 0.6875D,
			0.8125D, 1D);
	protected static final AxisAlignedBB LANTERN_SOUTH_AABB = new AxisAlignedBB(0.3125D, 0.0D, 0.0D, 0.6875D, 0.8125D,
			0.3125D);
	protected static final AxisAlignedBB LANTERN_WEST_AABB = new AxisAlignedBB(0.6875D, 0.0D, 0.3125D, 1.0D, 0.8125D,
			0.6875D);
	protected static final AxisAlignedBB LANTERN_EAST_AABB = new AxisAlignedBB(0D, 0.0D, 0.3125D, 0.3125D, 0.8125D,
			0.6875D);
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		if (enumfacing == EnumFacing.NORTH || enumfacing == EnumFacing.SOUTH) {
			...
			worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0 + 0.27D * (double) enumfacing1.getFrontOffsetX(),
					d1 + 0.125D + d3, d2 + 0.27D * (double) enumfacing1.getFrontOffsetZ() + .0625D, 0.0D, 0.0D, 0.0D,
					new int[0]);
			...
			worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL,
					d0 + 0.27D * (double) enumfacing1.getFrontOffsetX() + .0625D, d1 + 0.125D + d3,
					d2 + 0.27D * (double) enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D, new int[0]);
			worldIn.spawnParticle(EnumParticleTypes.FLAME, d0 + 0.27D * (double) enumfacing1.getFrontOffsetX() + .0625D,
					d1 + 0.125D + d3, d2 + 0.27D * (double) enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D,
					new int[0]);
		}
		// If its on the floor
		else if (enumfacing == EnumFacing.UP) {
			worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0, d1 + 0.125D + d3, d2, 0.0D, 0.0D, 0.0D,
					new int[0]);
			worldIn.spawnParticle(EnumParticleTypes.FLAME, d0, d1 + 0.125D + d3, d2, 0.0D, 0.0D, 0.0D, new int[0]);
		}
		// If its on the cieling
		else if (enumfacing == EnumFacing.DOWN) {
			worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0, d1 + 0.125D + d3 + 0.0625D, d2, 0.0D, 0.0D, 0.0D,
					new int[0]);
			worldIn.spawnParticle(EnumParticleTypes.FLAME, d0, d1 + 0.125D + d3 + 0.0625D, d2, 0.0D, 0.0D, 0.0D,
					new int[0]);
		}
	}
