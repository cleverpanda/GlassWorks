...
public class OnJoinWorldHandler {
    ...
    {
    	if (!GlassWorks.haveWarnedVersionOutOfDate && event.player.worldObj.isRemote){
    		ClickEvent versionCheckChatClickEvent = new ClickEvent(ClickEvent.Action.OPEN_URL, 
                    "https://github.com/cleverpanda/GlassWorks");
              ...
              TextComponentString versionWarningChatComponent = 
                    new TextComponentString("This build of Glassworks is Alpha and not feature complete! There may be bugs. Click this message to go to the GitHub.");
              versionWarningChatComponent.setStyle(clickableChatStyle);
              
              event.player.addChatMessage(versionWarningChatComponent);
              GlassWorks.haveWarnedVersionOutOfDate = true;
    	}
